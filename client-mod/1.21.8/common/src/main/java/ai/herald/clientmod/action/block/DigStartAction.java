...
/** Port of BlackBoxPro block/DigStartAction.kt. */
public final class DigStartAction implements ActionExecutor {
    ...
    public ActionResult execute(JsonObject params) {
        ...
        conn.send(new ServerboundPlayerActionPacket(Action.START_DESTROY_BLOCK, new BlockPos(x, y, z), face, sequence));
