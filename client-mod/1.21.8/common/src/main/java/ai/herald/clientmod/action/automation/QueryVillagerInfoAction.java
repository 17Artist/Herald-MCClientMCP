...
public final class QueryVillagerInfoAction implements ActionExecutor {
    ...
    public ActionResult execute(JsonObject params) {
        ...
        ResourceLocation professionId = BuiltInRegistries.VILLAGER_PROFESSION.getKey(villagerData.profession().value());
        ResourceLocation typeId = BuiltInRegistries.VILLAGER_TYPE.getKey(villagerData.type().value());
