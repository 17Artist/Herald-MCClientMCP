...
public final class QueryWorldStateAction implements ActionExecutor {
    ...
    public ActionResult execute(JsonObject params) {
        ...
        data.addProperty("timeOfDay", level.getDefaultClockTime());
        data.addProperty("worldTime", level.getLevelData().getGameTime());
        ...
        data.addProperty("difficulty", level.getDifficulty().getSerializedName());
