...
/** Port of BlackBoxPro container/PickItemFromBlockAction.kt. */
public final class PickItemFromBlockAction implements ActionExecutor {

    @Override
    public ActionResult execute(JsonObject params) {
        JsonUtil.requireInt(params, "x");
        JsonUtil.requireInt(params, "y");
        JsonUtil.requireInt(params, "z");
