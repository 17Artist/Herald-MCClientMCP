...
/** Port of BlackBoxPro block/DigFinishAction.kt. */
public final class DigFinishAction implements ActionExecutor {
    ...
    public ActionResult execute(JsonObject params) {
        ...
        conn.send(new ServerboundPlayerActionPacket(Action.STOP_DESTROY_BLOCK, new BlockPos(x, y, z), face, sequence));
