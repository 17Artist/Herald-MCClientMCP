...
public final class DebugFillBlocksAction implements ActionExecutor {
    ...
    public ActionResult execute(JsonObject params) {
        ...
        if (mc.getSingleplayerServer() != null) {
            ...
            Block block = McVersionCompat.registryGet(BuiltInRegistries.BLOCK, Identifier.tryParse(fullId));
            if (block == null || block == McVersionCompat.<net.minecraft.world.level.block.Block>registryGet(BuiltInRegistries.BLOCK, Identifier.tryParse("minecraft:air")) && !fullId.equals("minecraft:air")) {
