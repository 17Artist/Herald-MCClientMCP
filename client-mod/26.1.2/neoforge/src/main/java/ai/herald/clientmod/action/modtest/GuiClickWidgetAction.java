...
public final class GuiClickWidgetAction implements ActionExecutor {
    ...
    public ActionResult execute(JsonObject params) {
        ...
        if (params != null && params.has("x") && params.has("y") && !params.has("index") && !params.has("text")) {
            ...
            McVersionCompat.mouseClicked(screen, x, y, 0);
        ...
        var clickEvent = new net.minecraft.client.input.MouseButtonEvent(cx, cy, new net.minecraft.client.input.MouseButtonInfo(0, 0));
        target.onClick(clickEvent, false);
