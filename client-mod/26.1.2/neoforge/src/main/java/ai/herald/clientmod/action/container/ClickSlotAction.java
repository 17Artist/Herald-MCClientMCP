...
public final class ClickSlotAction implements ActionExecutor {
    ...
    public ActionResult execute(JsonObject params) {
        ...
        ContainerInput type;
        switch (mode) {
            case 0: type = ContainerInput.PICKUP; break;
            case 1: type = ContainerInput.QUICK_MOVE; break;
            case 2: type = ContainerInput.SWAP; break;
            case 3: type = ContainerInput.CLONE; break;
            case 4: type = ContainerInput.THROW; break;
            case 5: type = ContainerInput.QUICK_CRAFT; break;
            case 6: type = ContainerInput.PICKUP_ALL; break;
