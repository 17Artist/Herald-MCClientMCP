    ...
    public ActionResult execute(JsonObject params) {
        ...
        if (count <= 0) {
            ...
            McVersionCompat.sendContainerClick(conn,
                    containerId, stateId, fromContainer, 0, ContainerInput.PICKUP,
                    menu.getCarried(), changed1);

            Int2ObjectMap<ItemStack> changed2 = new Int2ObjectOpenHashMap<>();
            McVersionCompat.sendContainerClick(conn,
                    containerId, stateId + 1, toContainer, 0, ContainerInput.PICKUP,
            ...
            McVersionCompat.sendContainerClick(conn,
                    containerId, stateId + 2, fromContainer, 0, ContainerInput.PICKUP,
            ...
            for (int i = 0; i < count; i++) {
                ...
                McVersionCompat.sendContainerClick(conn,
                        containerId, stateId + 1 + i, toContainer, 1, ContainerInput.PICKUP,
            ...
            McVersionCompat.sendContainerClick(conn,
                    containerId, stateId + 1 + placed, fromContainer, 0, ContainerInput.PICKUP,
