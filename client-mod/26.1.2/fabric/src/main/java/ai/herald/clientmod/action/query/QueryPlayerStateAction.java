...
public final class QueryPlayerStateAction implements ActionExecutor {
    ...
    public ActionResult execute(JsonObject params) {
        ...
        if (level != null) {
            ...
            String biomeStr = biomeKey.map(k -> k.identifier().toString()).orElse("unknown");
            data.addProperty("biome", biomeStr);
        } else {
        ...
        if (mainItem.isEmpty()) {
            ...
            Identifier itemId = BuiltInRegistries.ITEM.getKey(mainItem.getItem());
