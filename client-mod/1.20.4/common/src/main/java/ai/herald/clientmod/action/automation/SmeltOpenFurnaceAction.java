...
/**
 * Sync: Interact with a furnace/blast furnace/smoker to open its GUI.
 * Params: x, y, z (block position)
 */
public final class SmeltOpenFurnaceAction implements ActionExecutor {
    ...
    public ActionResult execute(JsonObject params) {
        ...
        BlockHitResult hit = new BlockHitResult(cursor, Direction.NORTH, pos, false);
