 ...
 * MC 1.21.4+ uses ClientInformation with ParticleStatus parameter.
 */
    ...
    public ActionResult execute(JsonObject params) {
        ...
        try {
            ClientInformation info = new ClientInformation(
                    locale, viewDistance, vis, chatColors, skinParts, arm,
                    textFiltering, allowServerListings, ParticleStatus.ALL);
            conn.send(new ServerboundClientInformationPacket(info));
