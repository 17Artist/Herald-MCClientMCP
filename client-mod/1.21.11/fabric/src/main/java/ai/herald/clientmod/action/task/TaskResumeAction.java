...
public class TaskResumeAction implements ActionExecutor {
    @Override
    public ActionResult execute(JsonObject params) {
        ...
        if (!entry.status.equals("paused")) {
            return ActionResult.error(ErrorCode.INVALID_PARAMS, "Task is not paused, current status: " + entry.status);
        }
