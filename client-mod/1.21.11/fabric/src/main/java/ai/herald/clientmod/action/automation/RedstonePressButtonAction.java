...
/**
 * Sync: Press a button at the given position by interacting with it.
 * Params: x, y, z
 */
public final class RedstonePressButtonAction implements ActionExecutor {
    ...
    public ActionResult execute(JsonObject params) {
        ...
        data.addProperty("pressed", result.consumesAction());
